    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_URL}/yapping/p/${username}`, {
                    method: 'GET',
                    headers: {
...
YappingOther.propTypes = {
    username: PropTypes.string.isRequired, // Menggunakan PropTypes di sini
};

export default YappingOther;
